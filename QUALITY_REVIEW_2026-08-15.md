...
- Android 16 AVD 2대 기존 계측: 각 27/27, 현재 HEAD `emulator-5556` 전체 suite 29/29
...
가중 점수는 `90×0.25 + 91×0.20 + 96×0.15 + 92×0.25 + 94×0.10 + 96×0.05 = 92.3`이다. 자동 도구는 Kotlin 파일을 검사하지 못하고 macOS `awk` 오류로 `0.00/F`를 출력해 N/A다. 실제 근거는 Android 단위 69/69, UI 29/29, lint 오류 0·경고 14, R8 release/benchmark build와 고노이즈 바코드 실측이다.
