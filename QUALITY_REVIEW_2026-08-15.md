...
- 최종 100개 스크롤 CPU frame P50/P90/P99: 22.8/32.9/55.0ms → 22.5/32.1/42.9ms
...
- 3,000×2,000 파일 기준 preview 338.305ms/1,382,400B, zoom 268.368ms/12,441,600B, PSS 11,629KB. preview bitmap은 후축소 전 6,000,000B보다 77.0% 작음
...
- 프로필 적용 후에도 최종 스크롤 P50 22.5ms와 P90 32.1ms 모두 60fps frame budget 16.7ms를 넘는다.
- 세 번의 A/B에서 스크롤 P90 개선폭이 29.6%, 6.8%, 2.3%로 크게 달라 에뮬레이터 측정 재현성이 부족하다.
