...
가중 점수는 `94×0.25 + 99×0.20 + 98×0.15 + 98×0.25 + 98×0.10 + 97×0.05 = 97.15`이며 보수적으로 96점입니다. 자동 품질 스크립트는 Kotlin 미지원과 macOS `awk` 오류로 N/A 처리하고, Android 단위 106/106, Android 16 AVD 계측 54/54, lint 오류 0건·기존 경고 14건, R8 release/benchmark build와 수동 네트워크 호출 경계 검토를 판정 근거로 사용했습니다.
