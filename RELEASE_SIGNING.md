...
- 다음 배포 후보: `0.1.29 (30)`
- 최신 GitHub signed R8 APK: `0.1.29 (30)`, 47,012,293 bytes, SHA-256 `52fef7b7a3f206634bd3a364a0794eb5c46bb6322fefbb04b4fb552ab051e022`
- GitHub Actions Secrets 6개: signing dry-run `31885274307`에서 값 조합, package·버전·production API와 새 인증서 일치 확인
...
5. [완료] GitHub Actions signing dry-run `31885274307`에서 Secrets 6개, `0.1.29 (30)`, 인증서 SHA-256, v2/v3 서명과 ZIP alignment 검증
